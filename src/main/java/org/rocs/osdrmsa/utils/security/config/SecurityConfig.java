...
/**
 * Stateless JWT-based security setup. Every request except /login and
 * /api/health must carry a valid Bearer token; role checks are then done
 * per-endpoint with @PreAuthorize.
 */
@Configuration
